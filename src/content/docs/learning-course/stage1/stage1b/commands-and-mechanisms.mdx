...
The Java compiler will catch this and throw a compile-time error.

<Aside type="note">
    Can you figure out why the error message says "bind it to a trigger"?
    This is left as an exercise to the reader.

    <Aside type="answer" title="JK, we'll give you the solution">
...
[^1]: WPILib JavaDocs for [`NeedsNameBuilderStage.named()`](<https://github.wpilib.org/allwpilib/docs/beta/java/org/wpilib/command3/NeedsNameBuilderStage.html#named(java.lang.String)>)
