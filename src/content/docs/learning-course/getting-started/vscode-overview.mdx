...
5. **Command Palette** is accessed through `Ctrl+Shift+P` / `Cmd+Shift+P` or the WPILib button in the upper toolbar, and it allows for you to search and run any command in VS Code.
...
<Aside type="tip">
    VS Code has many accessibility features that some may find helpful. More
    information on these features can be found on [VS Code's documentation
    page.](https://code.visualstudio.com/docs/configure/accessibility/accessibility)
</Aside>
