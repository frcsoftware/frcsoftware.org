...
:::figure{w=60}
![3D printing process](../img/design-for-3d-printing/3dp-process.png)
3D printing process
:::
...
:::figure{w=60}
![Bambu A1](../img/design-for-3d-printing/3dp-bambu-a1.png)
Bambu A1 - [Bambulab.com](http://Bambulab.com)
:::
