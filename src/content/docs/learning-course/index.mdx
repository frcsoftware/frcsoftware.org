...
>
    <p>
        Stage 2 builds on what students learned in Stage 1 to program a real FRC robot, team 4322 Clockwork's 2025 off-season robot MIDTIDE.
        Students will program the elevator, arm, claw, intake, and indexer mechanisms, learn about feedfoward control, gain more experience with PID control, develop teleop modes with automation and driver enhancements, and learn about effectively structuring a robot program.
    </p>
</CourseSection>
