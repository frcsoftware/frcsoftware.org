...
[^1]: WPILib JavaDocs for [`NeedsNameBuilderStage.named()`](<https://github.wpilib.org/allwpilib/docs/2027/java/org/wpilib/command3/NeedsNameBuilderStage.html#named(java.lang.String)>)
