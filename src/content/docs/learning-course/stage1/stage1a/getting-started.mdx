...
<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    <TabItem label="CTRE">
        First, the [CTRE Template](https://github.com/frcsoftware/Stage1-Template-CTRE)

        To clone:
        - Open VS Code
        - Go to `Clone Git Repository`
        - You can also select the Git Icon on the left
        - Copy and paste the link
        - Create a `stage1a` folder and select it
        - Done!
    </TabItem>
    <TabItem label="REV">
        First, open the [REV Template](https://github.com/frcsoftware/Stage1-Template-REV)
