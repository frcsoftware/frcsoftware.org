...
As mentioned in the [Stage 0 overview](/learning-course/stage0/stage-overview/), Stage 0 only covers the basics, so there's still a lot more Java to learn.
This page lists **optional** resources for exploring Java further.
You can skip it for now, and come back at any point.
