...
<Aside type="note">
    Your code will only work completely after you complete Stage 1A. Make sure
    to complete Stage 1A!
</Aside>

### Task 1: Setup

Use git to fork and clone stage 1B template code.
If you need help, read over [the Forking and Cloning guide](/learning-course/getting-started/forking-and-cloning/).

<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    <TabItem label="CTRE">
        Fork then Clone the [CTRE Template](https://github.com/frcsoftware/Stage1B-Template-CTRE)

    </TabItem>
    <TabItem label="REV">
       Fork then Clone the [REV Template](https://github.com/frcsoftware/Stage1B-Template-REV)
...
<Aside type="note" title="What does Scheduler.getDefault().run() do?" collapse>
...
<Tabs syncKey={REV_CTRE_CHOOSER_KEY}>
    ...
    <TabItem label="REV">
        ...
        <Aside type="hint" title="Item 1 Hint">
...
<Aside type="hint" title="Items 2-4, Hint 1">
...
<Aside type="hint" title="Item 5, Hint 1">
...
<Aside type="hint" title="Item 2 Hint">
    Call `coroutine.wait(Seconds.of(2))` to wait 2 seconds within a `Command`. 
    You can import `Seconds` with `import static org.wpilib.units.Units.Seconds;`
</Aside>
<Aside type="hint" title="Item 6 Hint">
