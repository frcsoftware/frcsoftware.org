...
![Field Element Layout Sketch](../img/2a/Field Elements.webp)
...
![Sketched Shooter Ball Trajectory](../img/2a/Constrained Shot Angle.webp)
...
![Finished Layout Sketch](../img/2a/Finished Master Sketch.webp)
