...
Upper snake case is used for constants, which are fixed values shared by the whole program, like a gear ratio.
...
Creating variable names can be fun, but the names should always be descriptive and easy to read.
...
That is, all whitespace (such as new lines, spaces, and indentation) is treated identically, and adding more does not affect how your code is executed.
...
If you need additional help on how to set up a repository, read over [the Forking and Cloning guide](/learning-course/getting-started/forking-and-cloning/).
