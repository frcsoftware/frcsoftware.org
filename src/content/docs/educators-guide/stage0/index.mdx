...
Each page has a set of exercises that students should complete which will help them build an understanding of each new topic.
...
For students who want to learn more Java or want extra practice, we recommend the [Additional Resources](/learning-course/stage0/additional-resources/) page.
