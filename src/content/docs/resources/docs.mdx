...
{/* The wpilib.org hostnames below are lowercase because that's the domain, so the WPILib casing rule must not "correct" them. */}
{/* vale Vale.Terms = NO */}

| Name           | Docs Site                                          | API Docs                                                      |
| :------------- | :------------------------------------------------- | :------------------------------------------------------------ |
| WPILib         | https://docs.wpilib.org/en/latest/                 | https://github.wpilib.org/allwpilib/docs/beta/java/index.html |
