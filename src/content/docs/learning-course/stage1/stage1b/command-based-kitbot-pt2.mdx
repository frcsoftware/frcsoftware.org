...
<Aside type="hint">Refer back to Stage 1A for how to do these steps.</Aside>
...
<Aside type="hint" title="Item 3 Hint">
...
<Aside type="hint" title="Hint 5">
    To run 2 commands simultaneously, call `coroutine.awaitAll(command1, command2)` inside
    of another command.
</Aside>

# Running everything in sim

Just like in stage 1A, you can press `W` to drive forward, `S` to drive backward,
`A` and `D` to rotate, `E` to intake and `R` to outtake.
...
<Aside type="note">
    For instructions on how to setup sim, see
    [here](/learning-course/stage1/stage1a/drivetrain-sim/#simulating-code) and
    [here](/learning-course/stage1/stage1a/kitbot-additional-motors/#3d-sim).
</Aside>
